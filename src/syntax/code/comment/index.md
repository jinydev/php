---
layout: php
title: "PHP 주석 (Comments)"
description: "PHP에서 소스 코드의 설명을 기술하거나 실행에서 일시적으로 제외하기 위해 사용하는 주석(Comment) 문법(한 줄 주석, 여러 줄 주석, PHPDoc)을 학습합니다."
keyword: "php 주석, php comment, 한 줄 주석, 여러 줄 주석, phpdoc"
breadcrumb:
- syntax
- code
- comment
...
* **📁 세부 항목 바로가기**
  * [한 줄 주석 (Single-line Comment)](line)
  * [여러 줄 주석 (Block Comment)](block)
...
## 여러 줄 주석 처리
---
여러 줄 주석 처리 기능은 한 줄 처리 주석과 달리 여러 줄의 내용을 한꺼번에 주석으로 처리하고자 할 때 사용하는 방법입니다. 특정 블록 영역을 주석으로 처리할 때 매우 편리합니다. 여러 줄을 주석으로 처리하는 방법은 `/*`로 시작해서 `*/`로 블록을 정하면 됩니다. 해당 기호로 감싸인 내용은 프로그램 소스상에서 주석으로 처리되어 실행되지 않습니다.  
 
자세한 문법과 중첩 금지 등의 유의사항은 [여러 줄 주석 (Block Comment)](block) 페이지를 참고하시기 바랍니다.
