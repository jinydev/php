...
<div style="text-align: center; margin: 30px 0;">
  <img src="img/anonymous_function_flow.svg" alt="Anonymous Function Variable Binding and Callbacks Diagram" style="max-width: 100%; height: auto; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
  <p style="font-size: 13px; color: #64748b; margin-top: 8px;">그림: 익명 함수의 변수 바인딩(가변 식별자 대입) 및 고차 함수의 인라인 콜백 동작 구조</p>
</div>
