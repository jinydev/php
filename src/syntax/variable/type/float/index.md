...
layout: php
title: "실수형 (Float) 자료형"
description: "소수점을 포함하거나 지수 표기법을 통해 정수보다 넓은 범위의 실수를 표현하는 PHP 실수(Float/Double) 자료형의 특징과 버림, 올림, 반올림 등의 소수점 처리 함수를 배웁니다."
keyword: "php 실수형, php float, 소수점 처리, ceil floor round"
breadcrumb:
- syntax
- variable
- type
...
<div style="text-align: center; margin: 30px 0;">
  <img src="img/float_concept_cartoon.png" alt="Float vs Integer Concept Cartoon" style="max-width: 60%; height: auto; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
  <p style="font-size: 13px; color: #64748b; margin-top: 8px;">그림: 쪼개지지 않는 온전한 사과 개수(정수 = 3)와 소수점 단위로 쪼갤 수 있는 사과 개수(실수 = 3.5) 비교</p>
</div>
