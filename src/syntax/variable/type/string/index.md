---
layout: php
title: "문자열 (String) 자료형"
description: "PHP 문자열(String) 자료형의 특징과 생성 방법, 배열처럼 문자열의 개별 문자에 접근하는 방법 등을 알아봅니다."
keyword: "php 문자열, php string, 문자열 생성, 문자열 배열, is_string, 특수문자"
breadcrumb:
- syntax
- variable
- type
...
<div style="text-align: center; margin: 30px 0;">
  <img src="img/string_concept_cartoon.png" alt="String Concept Cartoon" style="max-width: 60%; height: auto; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
  <p style="font-size: 13px; color: #64748b; margin-top: 8px;">그림: 개별 문자(Character)가 연결 고리(String)에 의해 순서대로 엮여서 완성되는 문자열 개념</p>
</div>
