---
layout: php
title: "정수형 (Integer) 자료형"
description: "소수점이 없는 정수를 10진수, 8진수, 16진수 등으로 표현하며, 부호 여부에 따른 표현 범위(Signed/Unsigned) 및 진법 변환 함수를 배웁니다."
keyword: "php 정수형, php integer, 부호 있는 정수, 2진수 8진수 16진수"
breadcrumb:
- syntax
- variable
- type
...
# 정수형
---
정수(Integer)는 소수점이나 분수 부분이 없는 온전한 숫자를 말합니다. 컴퓨터 프로그래밍에서 정수는 데이터를 세거나(Count), 반복문 루프 횟수를 지정하거나, 인덱스를 표시할 때 가장 널리 사용되는 기본 데이터 형식입니다.

<div style="text-align: center; margin: 30px 0;">
  <img src="img/intiger_concept_cartoon.png" alt="Integer Concept Cartoon" style="max-width: 60%; height: auto; border: 1px solid #e2e8f0; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);" />
  <p style="font-size: 13px; color: #64748b; margin-top: 8px;">그림: 수직선 상에서 딱 떨어지는 정수 눈금(2)과 소수점이 포함된 정수가 아닌 수(1.5)의 구분</p>
</div>
