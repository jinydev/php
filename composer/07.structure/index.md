...
## 07.3 패키지 폴더
---
네임스페이스 두번째 구분자는 패키지의 이름으로 사용을 합니다. 패키지의 이름은 자신의 벤더명 서브로 배포자가 적절하게 이름이 중복되지 않도록 지정을 하여 사용을 하면 됩니다. 
...
주로 소스코드들은 src 폴더를 별도 추가하여 넣어 놓습니다. 패키지에서 서브 폴더를 구분하여 작업을 할 경우에는 composer.json 파일에서도 소스의 서브 경로를 같이 지정해 주어야 합니다.
